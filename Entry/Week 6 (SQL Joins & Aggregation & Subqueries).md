...
> 
1. Solve the following SQL problems: *(10 pts.)*
...
3. Compare between different types of SQL Joins (Inner, Left, Right, Full, Cross) and provide a brief explanation of when to use each type. *(5 pts.)*