...
> 
1. Write a blog on one of the topics you learned this week, and post it on medium or a similar website. Submit the link to your blog post. *(8 pts.)*
...
2. Read this [case study](https://drive.google.com/file/d/1tZWtp5GXDZ-oG4muMASt63ix7MaZnGop/view), then:
    - Design an ERD for the case study. You can use any tool you like (e.g. [ERDPlus](https://erdplus.com/)). *(5 pts.)*
    - Map your ERD to table schemas. You can use [this tool](https://dbdiagram.io/home) to design the tables. *(5 pts.)*
    - Write SQL queries to create the tables you designed in the ERD. *(5 pts.)*
3. Solve these SQL Problems: *(4 pts.)*
...
4. **Research Question:** How can we do conditional statements in SQL? Explain with examples. *(3 pts.)*