...
Understand object-oriented programming principles and modular code organization to build scalable and maintainable JavaScript applications.
...
- Write examples illustrating the use of each of the following:
    ...
    - Setters and getters
    - Method chaining
- What is the difference between prototype methods and class methods?
- Why do we use modules in backend applications?
- Write the output and explain the difference between `this` keyword's value in the following examples:
