...
> 
1. Implement the practical RESTful API project from the resources. You can choose any of the practical RESTful API tutorials listed above. **Using TypeScript is required.** *(20 pts.)*
2. What are the key differences between Client-Side Rendering (CSR) and Server-Side Rendering (SSR)? *(5 pts.)*
3. Explain the naming conventions for RESTful APIs. *(5 pts.)*